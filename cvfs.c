//////////////////////////
/* 
    WELCOME TO MY "CUSTOMIZE VIRTUAL FILE SYSTEM PROJECT"
    Name : Piyush Chitte
    Date : 27/11/2021
...
/* Display Help Section to Access further project */
...
/* ls function to list files in database */
...
/* truncate is used to delete File */
